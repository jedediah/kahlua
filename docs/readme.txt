...
Everything in CLDC 1.1 is also included in standard Java so this run in most Java environments.
...
License
-------
Kahlua is distributed under the MIT licence which is the same as standard Lua which means you can
